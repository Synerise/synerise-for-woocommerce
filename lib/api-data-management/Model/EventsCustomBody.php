...
/**
 * EventsCustomBody Class Doc Comment
 *
 * @category Class
 * @package  Synerise\DataManagement
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EventsCustomBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'events_custom_body';
...
'params' => 'getParams'    ];
     ...
     * Sets action
     *
     * @param string $action For custom events, enter your own action name. For pre-defined events, omit this field.<br>The action name can be up to 32 characters long and must match the following regular expression: `^[a-zA-Z0-9\\.\\-_]+$`
     *
     * @return $this
     */

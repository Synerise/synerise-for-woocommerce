...
/**
 * CalculateHistogramBody1 Class Doc Comment
 *
 * @category Class
 * @package  Synerise\DataManagement
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CalculateHistogramBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'calculate_histogram_body_1';
...
'date_filter' => 'OneOfcalculateHistogramBody1DateFilter',
...
'aggregate_data_by' => 'getAggregateDataBy'    ];
     ...
     * Gets date_filter
     *
     * @return OneOfcalculateHistogramBody1DateFilter
     */
     ...
     * Sets date_filter
     *
     * @param OneOfcalculateHistogramBody1DateFilter $date_filter Details of the date filter. The analysis results are calculated from data that matches the filter.
     *
     * @return $this
     */

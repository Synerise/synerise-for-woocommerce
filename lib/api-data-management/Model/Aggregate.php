 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Aggregate implements ModelInterface, ArrayAccess
{
...
'action_id' => 'int',
'attribute' => 'OneOfAggregateAttribute',
'type' => 'string',
'size' => 'int',
'unique' => 'bool',
'date_filter' => 'OneOfAggregateDateFilter',
...
self::TYPE_BOTTOM_MULTI,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_filter'] === null) {
            $invalidProperties[] = "'date_filter' can't be null";
        }
     ...
     * Gets attribute
     *
     * @return OneOfAggregateAttribute
     */
     ...
     * Sets attribute
     *
     * @param OneOfAggregateAttribute $attribute The type of data to apply a match logic to. You can analyze parameters, expressions, and special data types. In this object, you provide the source of data.
     *
     * @return $this
     */
     ...
     * Gets date_filter
     *
     * @return OneOfAggregateDateFilter
     */
     ...
     * Sets date_filter
     *
     * @param OneOfAggregateDateFilter $date_filter Details of the date filter. The analysis results are calculated from data that matches the filter.
     *
     * @return $this
     */
